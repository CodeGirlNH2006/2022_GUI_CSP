...
ping_btn = tk.Button(frame, text="Check to see if a URL is up and active",
    ...
    relief="raised",
    cursor="heart",
    bg="palevioletred", activebackground="violetred")
ping_btn.pack()

ns_btn = tk.Button(frame, text="Click to run nslookup",
    ...
    relief="flat",
    cursor="circle",
    bg="skyblue", activebackground="deepskyblue")
ns_btn.pack()

trace_btn = tk.Button(frame, text="Click to run tracert",
    ...
    relief="groove",
    cursor="spider",
    bg="yellow", activebackground="gold")
trace_btn.pack()

save_btn = tk.Button(frame, text="Click to save",
    command=lambda:mSave("mSave"),
    compound="center",
    font=("comic sans", 12),
    bd=0,
    relief="ridge",
    cursor="star",
    bg="seagreen", activebackground="darkseagreen")
save_btn.pack()
